/** Types generated for queries found in "apps/api/src/app/database/queries/02_assets/search/search_assets.sql" */
import { PreparedQuery } from '@pgtyped/runtime';

export type status_enum = 'active' | 'deleted' | 'inactive' | 'pending' | 'suspended';

/** 'SearchAssets' parameters type */
export type ISearchAssetsParams = void;

/** 'SearchAssets' return type */
 ...
 * ```
 */
export const searchAssets = new PreparedQuery<ISearchAssetsParams,ISearchAssetsResult>(searchAssetsIR);
