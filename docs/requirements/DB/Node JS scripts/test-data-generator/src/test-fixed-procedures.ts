import { Pool } from 'pg';
import { FixedStoredProcedureTester } from './FixedStoredProcedureTester';
...
async function main() {
  ...
  try {
    ...
    // Initialize tester
    const tester = new FixedStoredProcedureTester(pool);
...
export { main as testFixedStoredProcedures };