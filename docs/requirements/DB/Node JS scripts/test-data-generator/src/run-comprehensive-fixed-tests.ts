import { Pool } from 'pg';
import { ComprehensiveProcedureTesterFixed } from './ComprehensiveProcedureTesterFixed';
 ...
 */
function generateMarkdownReport(summary: any, totalTime: number, successRate: string): string {
...
export { main as runComprehensiveFixedTests };