...
exports.EnhancedAssetGenerator = void 0;
...
class EnhancedAssetGenerator {
    ...
    determineWealthLevel(scenario) {
        if (scenario === 'mixed') {
            ...
            return faker_1.faker.datatype.boolean(0.3) ? 'high_net_worth' : 'mass_affluent';
        }
        return scenario;
    }
    ...
    generatePersonalDirectives(wealthLevel) {
        ...
        return {
            name: `${displayNames[type]} - ${faker_1.faker.person.lastName()} Family`,
    ...
    generateTrust(wealthLevel) {
        ...
        return {
            name: `${faker_1.faker.person.lastName()} Family ${trustType.replace('_', ' ')} Trust`,
    ...
    generatePersonalProperty(wealthLevel) {
        ...
        return {
            name: `${item.type.replace('_', ' ')} - ${faker_1.faker.commerce.productName()}`,
            ...
            category_specific_data: {
                ...
                condition: faker_1.faker.helpers.arrayElement(['excellent', 'very_good', 'good', 'fair'])
            }
        };
    }
    generateOperationalProperty(wealthLevel) {
        ...
        return {
            ...
            category_specific_data: {
                ...
                vin_or_serial: faker_1.faker.vehicle.vin(),
                condition: faker_1.faker.helpers.arrayElement(['operational', 'needs_repair', 'excellent']),
    ...
    generateInventory(wealthLevel) {
        ...
        return {
            name: `${type.replace('_', ' ')} Inventory - ${faker_1.faker.company.name()}`,
            description: `Business inventory of ${type}s`,
            estimated_value: value,
            category_specific_data: {
                inventory_type: type,
                quantity: faker_1.faker.number.int({ min: 10, max: 1000 }),
                unit_cost: value / faker_1.faker.number.int({ min: 10, max: 100 }),
                location: faker_1.faker.location.city(),
                last_inventory_date: faker_1.faker.date.recent({ days: 90 })
            }
        };
    }
    generateRealEstate(wealthLevel) {
        ...
        const propertyType = faker_1.faker.helpers.arrayElement(propertyTypes);
        const baseValue = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 500000, max: 20000000 })
            : faker_1.faker.number.int({ min: 150000, max: 1500000 });
        return {
            name: `${propertyType.replace('_', ' ')} - ${faker_1.faker.location.streetAddress()}`,
            ...
            category_specific_data: {
                ...
                square_footage: faker_1.faker.number.int({ min: 1000, max: 10000 }),
                lot_size: faker_1.faker.number.float({ min: 0.1, max: 5.0 }),
                year_built: faker_1.faker.number.int({ min: 1950, max: 2023 }),
                bedrooms: faker_1.faker.number.int({ min: 2, max: 8 }),
                bathrooms: faker_1.faker.number.int({ min: 1, max: 6 }),
                purchase_date: faker_1.faker.date.past({ years: 15 }),
                mortgage_balance: baseValue * faker_1.faker.number.float({ min: 0, max: 0.8 })
            }
        };
    }
    generateLifeInsurance(wealthLevel) {
        ...
        const faceValue = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 1000000, max: 50000000 })
        ...
        return {
            ...
            category_specific_data: {
                ...
                cash_value: policyType === 'term' ? 0 : faceValue * faker_1.faker.number.float({ min: 0.1, max: 0.4 }),
                premium_amount: faceValue * faker_1.faker.number.float({ min: 0.005, max: 0.03 }),
                beneficiaries: Array.from({ length: faker_1.faker.number.int({ min: 1, max: 3 }) }, () => faker_1.faker.person.fullName()),
                policy_number: faker_1.faker.string.alphanumeric(10),
                insurance_company: faker_1.faker.company.name() + ' Insurance',
                issue_date: faker_1.faker.date.past({ years: 10 })
            }
        };
    }
    generateFinancialAccount(wealthLevel) {
        ...
        const accountType = faker_1.faker.helpers.arrayElement(accountTypes);
        const balance = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 100000, max: 25000000 })
            : faker_1.faker.number.int({ min: 5000, max: 500000 });
        return {
            name: `${accountType.replace('_', ' ')} Account - ${faker_1.faker.finance.accountName()}`,
            description: `${accountType.replace('_', ' ')} account`,
            estimated_value: balance,
            category_specific_data: {
                account_type: accountType,
                institution: faker_1.faker.company.name() + ' Financial',
                account_number: faker_1.faker.finance.accountNumber(),
                current_balance: balance,
                interest_rate: faker_1.faker.number.float({ min: 0.01, max: 0.08 }),
                opened_date: faker_1.faker.date.past({ years: 10 }),
                is_joint_account: faker_1.faker.datatype.boolean(0.3)
            }
        };
    }
    generateRecurringIncome(wealthLevel) {
        ...
        const incomeType = faker_1.faker.helpers.arrayElement(incomeTypes);
        ...
        return {
            ...
            category_specific_data: {
                ...
                is_guaranteed: faker_1.faker.datatype.boolean(0.6)
            }
        };
    }
    generateDigitalAssets(wealthLevel) {
        const assetTypes = ['cryptocurrency', 'domain_name', 'intellectual_property', 'nft', 'digital_media'];
        const assetType = faker_1.faker.helpers.arrayElement(assetTypes);
        const value = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 10000, max: 5000000 })
            : faker_1.faker.number.int({ min: 100, max: 50000 });
        return {
            name: `${assetType.replace('_', ' ')} - ${faker_1.faker.internet.domainName()}`,
            description: `Digital ${assetType.replace('_', ' ')} asset`,
            estimated_value: value,
            category_specific_data: {
                asset_type: assetType,
                platform: faker_1.faker.company.name(),
                wallet_address: assetType === 'cryptocurrency' ? faker_1.faker.finance.ethereumAddress() : undefined,
                registration_date: faker_1.faker.date.past({ years: 3 }),
                renewal_date: faker_1.faker.date.future({ years: 2 }),
    ...
    generateOwnershipInterests(wealthLevel) {
        ...
        const interestType = faker_1.faker.helpers.arrayElement(interestTypes);
        const value = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 500000, max: 50000000 })
            : faker_1.faker.number.int({ min: 10000, max: 500000 });
        return {
            name: `${interestType.replace('_', ' ')} Interest - ${faker_1.faker.company.name()}`,
            description: `Ownership interest in ${interestType.replace('_', ' ')}`,
            estimated_value: value,
            category_specific_data: {
                interest_type: interestType,
                entity_name: faker_1.faker.company.name(),
                ownership_percentage: faker_1.faker.number.float({ min: 5, max: 100 }),
                shares_owned: faker_1.faker.number.int({ min: 100, max: 10000 }),
                formation_date: faker_1.faker.date.past({ years: 10 }),
                tax_id: faker_1.faker.string.numeric(9)
            }
        };
    }
    generateLoans(wealthLevel) {
        ...
        const loanType = faker_1.faker.helpers.arrayElement(loanTypes);
        const amount = wealthLevel === 'high_net_worth'
            ? faker_1.faker.number.int({ min: 100000, max: 10000000 })
            : faker_1.faker.number.int({ min: 10000, max: 500000 });
        return {
            name: `${loanType.replace('_', ' ')} - ${faker_1.faker.finance.accountName()}`,
            ...
            category_specific_data: {
                ...
                interest_rate: faker_1.faker.number.float({ min: 0.02, max: 0.15 }),
                lender: loanType === 'interfamily_loan' ? faker_1.faker.person.fullName() : faker_1.faker.company.name() + ' Bank',
                origination_date: faker_1.faker.date.past({ years: 10 }),
                maturity_date: faker_1.faker.date.future({ years: 15 }),
                monthly_payment: amount * faker_1.faker.number.float({ min: 0.005, max: 0.02 })
            }
        };
    }
    generateAssetCreationDate() {
        return faker_1.faker.date.recent({ days: 365 });
    }
}
exports.EnhancedAssetGenerator = EnhancedAssetGenerator;
