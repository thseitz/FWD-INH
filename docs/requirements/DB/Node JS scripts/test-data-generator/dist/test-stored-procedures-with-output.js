...
exports.testStoredProceduresWithOutput = main;
const pg_1 = require("pg");
const StoredProcedureTester_1 = require("./StoredProcedureTester");
...
async function main() {
    ...
    try {
        ...
        console.log();
        // Initialize tester
        const tester = new StoredProcedureTester_1.StoredProcedureTester(pool);
        // Run all tests
 ...
 */
function generateMarkdownReport(summary, timestamp) {
