...
exports.FixedStoredProcedureTester = void 0;
const faker_1 = require("@faker-js/faker");
class FixedStoredProcedureTester {
    pool;
    tenantId = 1;
    testUserId = '';
    testPersonaId = '';
     ...
     */
    async testAllRoutines(client, summary) {
        ...
        await this.testFunction(client, summary, 'FFC Management', 'sp_add_persona_to_ffc', async () => {
            ...
            const result = await client.query('SELECT sp_add_persona_to_ffc($1, $2, $3, $4, $5) as success', Object.values(testData));
            return { testData, result: result.rows[0] };
        });
        ...
        await this.testFunction(client, summary, 'FFC Management', 'sp_update_ffc_member_role', async () => {
            ...
            const result = await client.query('SELECT sp_update_ffc_member_role($1, $2, $3, $4) as success', Object.values(testData));
            return { testData, result: result.rows[0] };
        });
        ...
        await this.testFunction(client, summary, 'Asset Management', 'sp_search_assets', async () => {
            ...
            const result = await client.query('SELECT * FROM sp_search_assets($1, $2, $3, $4, $5, $6, $7, $8, $9)', Object.values(testData));
        ...
        await this.testFunction(client, summary, 'Asset Management', 'sp_update_asset', async () => {
            ...
            const result = await client.query('SELECT sp_update_asset($1, $2, $3, $4, $5, $6, $7) as success', Object.values(testData));
            return { testData, result: result.rows[0] };
        });
        ...
        await this.testFunction(client, summary, 'Contact Management', 'sp_add_email_to_persona', async () => {
            ...
            const result = await client.query('SELECT sp_add_email_to_persona($1, $2, $3, $4, $5) as email_id', Object.values(testData));
            return { testData, result: result.rows[0] };
        });
        ...
        await this.testFunction(client, summary, 'Contact Management', 'sp_add_phone_to_persona', async () => {
            ...
            const result = await client.query('SELECT sp_add_phone_to_persona($1, $2, $3, $4, $5, $6) as phone_id', Object.values(testData));
            return { testData, result: result.rows[0] };
        });
...
exports.FixedStoredProcedureTester = FixedStoredProcedureTester;
