...
exports.runSafeTests = main;
const pg_1 = require("pg");
const SafeProcedureTester_1 = require("./SafeProcedureTester");
...
async function main() {
    ...
    `);
        ...
        console.log();
        // Initialize tester
        const tester = new SafeProcedureTester_1.SafeProcedureTester(pool);
        // Run all tests
...
function generateMarkdownReport(summary, totalTime) {
    ...
    categories.forEach(cat => {
        ...
        const catFailed = catResults.filter((r) => r.status === 'failure').length;
